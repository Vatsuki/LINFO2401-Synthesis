...
\begin{document}
	...
	Many countries, such as France, rely on "droits d'auteurs", patrimonial rights were the author has recognized perpetual rights on a work. Anglo-Saxon systems instead use copyright, a concept that originated in England as a tool for controlling and censoring book printing, and later evolved into a transferable “right to copy” non-rival goods.
	...
	\begin{itemize}
		\item \textbf{Droit d'auteur (Civil Law - France/Belgium):} 
		composed of:
		\begin{itemize}
			\item \textit{Droit Moral:} Perpetual, inalienable rights (right to recognition, right to integrity of the work). Example: An author can block their work from being used by a hate group.
			\item \textit{Droit Patrimonial:} Economic rights (right to sell/copy). These can be transferred/sold to an employer.
		\end{itemize}
	...
	\begin{itemize}
		\item \textbf{Default Copyright:} In most modern systems, every work is automatically under copyright the moment it is fixed in a medium. All rights are reserved; others cannot use, modify, or share it without permission.
		\item \textbf{Public Domain:} Works with no restrictions. Anyone can use/modify them. (Works usually enter here 70 years after the author's death—a limit famously extended by the "Mickey Mouse Protection Act" in the US).
	\end{itemize}
	...
	\subsubsection{Copyleft: The "No More Bricks" Brick}
