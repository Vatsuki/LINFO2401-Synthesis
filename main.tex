...
\begin{document}
	...
	The text traces the rapid spread of computers. From rare, massive machines to ubiquitous devices embedded in everyday objects—and argues that their growing complexity has outpaced most people’s understanding, including that of many engineers and programmers. Instead of deeply understanding computers and code, practitioners often rely on memorized techniques, copy-pasted solutions, and unexamined rules, building systems they do not truly understand.
	...
	\section{The Birth of UNIX and the Internet}
...
In toyota car, they put the worst engineer fo rthe soft part. “bc a car is about mechanical”. Toyota missile and they claimed a mechanical failure. But after investigation they found the worst code ever.
	...
	\textbf{Richard Stallman (RMS):} The MIT Printer Story (the catalyst for the movement).
	...
	1.	Use
	2.	Study : free to study the soft. What was the decision was used in the software. So you need the source code
	3.	Right to share, you can make copy of it
	4.	Right to modify
	Their is nothing about money. You couldn't technically sell it ?
	...
	\textbf{GNU Project:} Creating a free UNIX replacement (Tools, GCC, Emacs).
	...
	\subsection{Rival good VS non rival good}
	
	
	\begin{itemize}
		\item Rival : If i take pasta from the shop, their is one item less in the shop, the shop lose money, only one persone can use it. stealing
		
		\item Non rival : their is a bridge an dyou had to pay to cross the bridge. If you don’t pay and cross the bridge its not stealing in the sense that people who build the bridge didn’t lose money (lost money opportunity)
		...
		Coying music from cd to tape was a quality lost but not a problem, bc music was assiocated with the physical object.
		Before a book was really expensive (monk copy) then cheap with type machine. At the beginning their was no protection for author. The content could be “stolen”, ideas could be spread accross everywhere. The idea inside the bood was not rival anaymore. So it was a problem for the king that wanted to keep their power.
		Copyright was a pure censorship of book.
	\end{itemize}
	
	Droit d’auteur, composé de droit patrimonial and droit moral. 
	
	
	\subsection{Intellectual Property Laws}
	
	Droit moral could never be removed (have your name, be recognize has the author, author can say his work cannot be said by nazi party bc he will look like a nazy himself
	Droit patrimonial : right to sell, similar to the copyright. Their is no taxes on this rights (at least in Belgium) generally in a contract, you give all your patrimonial rights to the employer. 
	...
	When independence : USA said that they will not recognize any patent from Europe. So they can copy everything and grow faster. That’s how every contry start when they want to become industrial giant. WW2 has made american product know therfore they got a market to sell their product like coca cola.
	...
	Piracy is not bad :) the brain washed with the small scene at the beginning “you wouldn’t steal a car, piracy is a crime”, well the font they use was pirated, and every pirate didn’t event see this scene. OpenAI, Meta can pirate to train their AI models jsut bc they have money. Somes are protected by the lows, othrs must obey the lows.
	
	
	
	\subsection{Software Licenses (The Spectrum)}
	...
	License is ~a contract = agreement bewteen two party. Between the owner of the copyright of the software and the user.and could be a contract for each user. A license is a standardized contract and its not tied to the sofware but to a specific distribution of the software (bc can vary to each user). For example if we dl soft from github they will be a specifc license.
	One of the first license was the BSD : you can do whatever you wnat but you have to list the author.so compatible with the 4 Free statment of Stalman. But we cannot garantee that the sofware stay free.
	The license happend when their is a exchange (dl the source code), the act of distributing. So if you dl a code with a specific license, you have this license for life even if in githube the license change.
	...
	Family of licenses: 
	·	Proprietary (restricts the rights of the user).
	·	Permissive license (you can do whatever you want but must at least credit the original author: BSD, MIT).
	·	Copyleft license: GNU/GPL, you can change the license but with similar rights (compatible license). If you put a GPL code fragment, the whole software becomes GPL.
	GPL2 (Linux kernel license): Tivo problem, where you couldn’t run other software; and GPL3: you cannot prevent other source code from running on the same hardware. LGPL is for libraries and does not contaminate the whole process.
	...
	\subsection{Non-Software Licensing (Creative Commons)}
	 Adapting licenses for non-code assets (BY, SA, NC, ND).
	
	Creative Commons license: GPL, BSD, etc. are really focused on software. Now we want licenses for anything else: pictures, textbooks, games, anything that is not pure code. They can be used for code but don’t fit well. Games: license for the code and license for the assets of the game. The goal of the CC is to make a set of licenses for your own case. Do you want attribution to you? Do you want to allow other people to use your work commercially? Derivative works (can people modify it)? Are they forced to use the same license?
	Clauses:
	·	 BY: credit the author.
	·	 NC: non-commercial (so not a free license).
	·	SA: share alike, like copyleft, you have to keep the same rights (not a more restrictive license).
	·	ND: no derivatives, I don’t want any modification.
	...
	\section{Modern Challenges: Privacy, Security, \& Society}
